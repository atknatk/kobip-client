...
@Component({
  selector: 'kb-duallist-category-employee',
  template: `
      ...
      <div class="box2 col-md-12 m-t">
        ...
        <div class="row kb-firma_kategori">
          <div class="col-xs-12" *ngFor="let item of rightFilteredList">
            <div [innerHTML]="getSelectedDisplayHtml(item.display)"></div>
            <div (click)="selectRightList(item)" style="cursor: pointer">
...
export class KbDuallistCategoryEmployeeComponent implements OnInit {
