 ...
 */
type DefaultLanguageFunction = (languages: string[], cachedLang?: string, browserLang?: string) => string;
...
export class LocalizeRouterSettings implements LocalizeRouterConfig {
   ...
   */
  constructor(@Inject(USE_CACHED_LANG) public useCachedLang: boolean = true,
